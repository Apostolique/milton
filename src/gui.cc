...
milton_imgui_tick(MiltonInput* input, PlatformState* platform,  Milton* milton)
{
    ...
    static auto color_window_background = ImVec4{.5f, .5f, .5f, 1};
    //static auto color_title_bg          = color_window_background;
    static auto color_title_bg          = ImVec4{.2f,.2f, .2f,1};
    static auto color_title_fg          = ImVec4{.4f, .4f, .4f, 1};

    static auto color_buttons           = ImVec4{.2f, .2f, .2f, 1};
    static auto color_buttons_active    = ImVec4{.1f, .1f, .1f, 1};
    static auto color_buttons_hovered   = ImVec4{.3f, .3f, .3f, 1};

    static auto color_menu_bg           = ImVec4{.2f, .2f, .2f, 1};
    static auto color_text              = ImVec4{1.0f,1.0f,1.0f,1};
    static auto color_slider            = ImVec4{.5f, .5f, .5f,1};
    static auto frame_background        = ImVec4{.4f, .4f, .4f,1};
    static auto color_text_selected     = ImVec4{0.4f, 0.4f, 0.4f,1};
